<template>
  <div id="MainLayout" class="h-screen">
    ...
    >
      ...
      >
        <button @click="navigateTo(ROUTES.home)" class="w-full h-full">
          <Icon
        ...
        <button @click="isMenuOverlay = true" class="w-full h-full">
          <Icon
            class="mb-1"
        ...
        <button @click="isLogoutOverlay = true" class="w-full h-full">
...
const { isLogoutOverlay, isMenuOverlay } = storeToRefs(userStore)
</script>
